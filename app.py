...
# Clean inputs: all defaults and hardcoded strings completely removed
...
if salary_input and postcode_input:
    ...
    for _, row in df_hubs.iterrows():
        ...
        # Benchmark filtering uses local Band C average costs
        base_benchmark_cost = rent_share + tax_matrix["Band C"] + commute_share
        
        if base_benchmark_cost <= max_allowed:
            with st.container():
                ...
                with col_actions:
                    ...
                    if property_input == "Shared Flatshare / Room":
                        # Fixed automated search execution gateway
                        ...
                        # Clean outcode-targeted portal routing
